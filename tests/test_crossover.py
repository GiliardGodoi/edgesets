...
from edgesets.crossover import (CrossoverKruskalRST,
                                       CrossoverPrimRST,
                                       CrossoverRandomWalkRST)
from edgesets.generate import (gen_random_kruskal,
                                      gen_random_prim,
                                      gen_random_walk)
from ggraphs.steiner.parser import ParserORLibrary
from ggraphs import UndirectedGraph as UGraph
from ggraphs.util import is_steiner_tree
...
class TestCrossoverKruskalRSTBased(unittest.TestCase):
    ...
    def test_if_return_an_edgeset(self):
        ...
        stpg  = ParserORLibrary().parse(filename)
